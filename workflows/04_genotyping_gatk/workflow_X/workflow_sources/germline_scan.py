...
def main(vcf_file, father_id, mother_id, child_id, sex_file, output_file):
...
#                if 0.3 <= allele_balance <= 0.7:
                ...
                if father_gt == "0/0" and mother_gt == "0/0" and child_gt == "1/1":
                    vcf_writer.write_record(record)
...
if __name__ == "__main__":
    if len(sys.argv) != 7:
        print("Usage: python script.py <vcf_file> <father_id> <mother_id> <child_id> <sex_file> <output_vcf_file>")
        sys.exit(1)
